...
SUB_PATH = os.environ.get('SUB_PATH', 'xs111')           # 订阅token,默认sub，例如：https://www.google.com/sub
UUID = os.environ.get('UUID', 'acf3ccf9-27ab-4274-9b12-66074a7857e9')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'streamlit.855220.xyz')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiM2ViN2ZjYTU5MDJjMWE2NTk3ODU4YzEyZWIzYWE2OTkiLCJ0IjoiZWE0NWIwZDMtZmMwYS00OWJhLTk2NmYtYTdkZDRhNTljY2QxIiwicyI6IlpqTTJNR1UwTkdRdE5HVXdNeTAwTWpoakxXSmxaR0l0WkdOaE9XSXlZVGsyTmpZMSJ9')            # Argo固定隧道密钥,留空即使用临时隧道
